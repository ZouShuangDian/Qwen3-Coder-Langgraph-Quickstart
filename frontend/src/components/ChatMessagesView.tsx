...
const mdComponents = {
  ...
  a: ({ className, children, href, ...props }: MdComponentProps) => (
    <Badge className="text-xs mx-0.5">
      <a
        className={cn("text-blue-600 hover:text-blue-500 text-xs", className)}
        href={href}
        target="_blank"
          ...
          {isLoading &&
            (messages.length === 0 ||
              ...
              <div className="flex items-start gap-3 mt-3">
                ...
                <div className="relative group max-w-[85%] md:max-w-[80%] rounded-xl p-3 shadow-sm break-words bg-gray-50 text-gray-900 border border-gray-200 rounded-bl-none w-full min-h-[56px]">
